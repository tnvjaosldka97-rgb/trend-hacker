...
import { startDailyCollectionScheduler, startWeeklyETFCollectionScheduler, startReportScheduler } from "../scheduler";
...
async function startServer() {
  ...
  server.listen(port, () => {
    ...
    startReportScheduler(); // Pro: 매주 월요일 오전 9시, Premium: 매일 오전 9시 AI 리포트 생성
  });
}
